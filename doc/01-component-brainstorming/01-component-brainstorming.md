...
Outside of the Computer Science field, I enjoy freestyle jump rope, webnovels, manhwas, and drawing. I really enjoy designing and digital art has always been my creative outlet. Game development and design has always been a driving force in my intrest for programming which led me to puruse computer science in college. I often coded mini games using Scratch and websites with HTML and CSS in middle school. I especially enjoy the problem solving aspect of programming, but I'm not sure what specialization I would go into. I'm considering software engineering, AI, and game development.
...
- Component Design #1: Soup
  ...
  - **Additional Considerations** (*note*: "I don't know" is an acceptable
    answer for each of the following questions):
    - Would this component be mutable? Answer and explain:
      - yes, like the OSU components, Soup will inherit from Standard. `clear`, `newInstance`, and `transferFrom` all
        mutate `this`.
    - Would this component rely on any internal classes (e.g., `Map.Pair`)?
      Answer and explain:
...
- Component Design #2: Webtoon
  ...
  - **Additional Considerations** (*note*: "I don't know" is an acceptable
    answer for each of the following questions):
    - Would this component be mutable? Answer and explain:
      - Yes, like OSU components, Webtoons would inherit from Standard.
    - Would this component rely on any internal classes (e.g., `Map.Pair`)?
      Answer and explain:
...
- Component Design #3: WaterTracker
  - **Description**:
    - The purpose of this component is to track data related to water, such as water consumed and water goal. The intent with this design is to keep a simple kernal that provides the minimal functions for a water tracker. Then, we provide more complex features in the secondary interface.
  - **Kernel Methods**:
    - `void setGoal(int x)`: sets `this` to x
    - `T drank()`: subtracts 8 fluid ounces from `this`
    - `int goal()`: reports what `this` is
  - **Secondary Methods**:
    - `void newGoal(WaterTracker<T> q)`: adds q to the end of `this`
    - `T goalMet()`: reports how many entries met 0
  - **Additional Considerations** (*note*: "I don't know" is an acceptable
    answer for each of the following questions):
    - Would this component be mutable? Answer and explain:
      - Yes, like OSU components, WaterTracker will inherit Standard.
    - Would this component rely on any internal classes (e.g., `Map.Pair`)?
      Answer and explain:
      - No, WaterTracker will use only other Watertrackers and integers.
    - Would this component need any enums or constants (e.g.,
      `Program.Instruction`)? Answer and explain:
      - IDK
    - Can you implement your secondary methods using your kernel methods?
